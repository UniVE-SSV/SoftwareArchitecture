...
<div>
Previous: <a href="/SoftwareArcitectures/gradle/build.gradle">Gradle - build.gradle</a>
</div>
<div>
Next: <a href="/SoftwareArcitectures/gradle/example-log4j">Gradle - Example: log4j</a>  
</div>